<template>
  <section class="content-container app-container tcswh">
    ...
    <!--列表-->
    <el-table :data="tableData" v-loading="listLoading" highlight-current-row class="genTabel cusMiniScroll" style="width: 100%;">
...
<script>
  import $ from 'jquery'
  import searchApp from '@comm/components/searchbar'
  import {dqxnxqObj, getNj, getBj} from '@comm/api/base'
  import {
    getTcsLxList,
    getBjSdunt,
    getPageList,
  ...
  export default {
    ...
    created() {
      this.xxdm = this.$cookie.get('xxdm');
